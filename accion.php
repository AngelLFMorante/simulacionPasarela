...
$infoPago;
if($pago == "ok"){
    $infoPago = "fue realizado con éxito";
}else if($pago == "nook"){
    $infoPago = "que hubo un problema de al realizar el pago";
}else if($pago == "cancelado"){
    $infoPago = "que el pago fue cancelado por el usuario";
}
...
<body class="container">
    ...
    <h3 class="bordered">El resultado de la operación ha sido <?=$infoPago?></h3>
<hr>
